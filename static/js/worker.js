...
importScripts('/config.js', 'addressbook/db.js', 'addressbook/collected.js');
...
TkWorker.prototype = {
  ...
  loadContacts: function(cb) {
    this.contactsDb.allUsernames(function(err, contacts) {
      if (err) {
  ...
  updateContactList: function(contacts) {
    contacts.forEach(function(userId) {
      this.ports.broadcastDebug("contact:", userId);
